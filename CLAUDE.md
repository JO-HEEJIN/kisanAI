...
10. **NEVER CREATE DUPLICATE FUNCTIONS**. Always check if a function already exists before creating a new one. Duplicate functions cause syntax errors and runtime conflicts.
