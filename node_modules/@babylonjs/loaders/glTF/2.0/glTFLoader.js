    ...
    async _loadAsync(rootUrl, fileName, nodes, resultFunc) {
        return await Promise.resolve()
            ...
            if (this.parent.useOpenPBR) {
                ...
                const materialModule = await import("@babylonjs/core/Materials/PBR/openPbrMaterial.js");
                ...
                const materialModule = await import("@babylonjs/core/Materials/PBR/pbrMaterial.js");
