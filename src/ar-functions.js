...
window.showTargetClickGuidePopup = function() {
    ...
    popup.innerHTML = `
        ...
        <p style="color: #FFFFFF !important; font-size: 16px !important; line-height: 1.6 !important; margin: 0 !important;">
    ...
    // Auto-dismiss after 3 seconds, then show Pixel Hunt popup
    setTimeout(() => {
        if (overlay.parentElement) {
            ...
            setTimeout(() => {
                overlay.remove();
                // Show Pixel Hunt Challenge popup immediately after
                if (window.showPixelHuntChallengePopup) {
                    window.showPixelHuntChallengePopup();
                }
            }, 300);
        }
    }, 3000);
...
// Show Pixel Hunt Challenge reminder popup (shown after target guide)
window.showPixelHuntChallengePopup = function() {
    console.log('🎨 Showing Pixel Hunt Challenge popup...');

    // Create overlay
    const overlay = document.createElement('div');
    overlay.id = 'pixel-hunt-overlay';
    overlay.style.cssText = `
        position: fixed !important;
        top: 0 !important;
        left: 0 !important;
    ...
    popup.innerHTML = `
        <div style="font-size: 48px; margin-bottom: 15px;">🎮</div>
        <h2 style="color: #EAFE07 !important; font-size: 24px !important; font-weight: 700 !important; margin: 0 0 15px 0 !important;">
            Remember Pixel Hunt Challenge!
        </h2>
        <p style="color: #FFFFFF !important; font-size: 16px !important; line-height: 1.6 !important; margin: 0 !important;">
            Check the <strong style="color: #EAFE07 !important;">pixel panel</strong> below to see real-time colors and NASA data for each grid area
        </p>
    `;
    ...
    // Store overlay globally so pixel loading can close it
    window.pixelHuntOverlay = overlay;

    console.log('✅ Pixel Hunt Challenge popup shown');
};