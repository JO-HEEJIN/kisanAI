...
class ConversationalAI {
    ...
    /**
     * --- MODIFIED: Core logic now exclusively uses GPT-3.5 and provides a more helpful error message ---
     */
    async generateAIResponse(userMessage) {
        ...
        if (!this.openAIApiKey) {
            ...
            return "AI Assistant is offline. To enable it, please add your personal OpenAI API key in the main application's settings panel (click the ⚙️ icon in the top-right header).";
        }
